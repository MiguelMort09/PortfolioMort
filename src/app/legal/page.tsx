      ...
      <main className="container py-12">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground leading-relaxed">
                En cumplimiento con la Ley Federal de Protección al Consumidor y
                demás normativas aplicables en México, se proporciona la
                siguiente información legal sobre este sitio web y los servicios
                ofrecidos por <strong>Mort.dev</strong>.
              </p>
            </CardContent>
          </Card>
              ...
              <div className="bg-muted/50 p-6 rounded-lg space-y-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Servicios de Desarrollo Web y Consultoría Tecnológica
                  </p>
                </div>
                <div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Sitio web corporativo para la promoción y contratación de
                  servicios de desarrollo web, así como para proporcionar
                  información sobre proyectos y experiencia profesional.
                </p>
              </div>
              <div>
                <h3 className="font-semibold mb-2">Audiencia:</h3>
                <p className="text-muted-foreground">
                  Empresas, emprendedores y organizaciones que requieren
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground leading-relaxed">
                ...
                limitándose a textos, imágenes, gráficos, logotipos, iconos,
                código fuente y diseño, son propiedad de Miguel Uicab (Mort.dev)
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 text-muted-foreground">
                  ...
                  <li>
                    No se permite el uso comercial de los contenidos sin
                    consentimiento
                  </li>
                  <li>
                    Las marcas comerciales mencionadas pertenecen a sus
                    respectivos propietarios
                  </li>
                  <li>
                    El código fuente del sitio está protegido por derechos de
                    autor
                  </li>
                </ul>
              </div>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <p className="text-muted-foreground mb-3">
                  Aunque nos esforzamos por mantener la información actualizada
                  y precisa, no garantizamos la exactitud, completitud o
                  actualidad de toda la información presentada en este sitio.
                </p>
              </div>
              <div>
                ...
                <p className="text-muted-foreground mb-3">
                  ...
                  somos responsables del contenido o las prácticas de privacidad
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  No garantizamos la disponibilidad continua del sitio web y no
                  seremos responsables por interrupciones temporales del
                  servicio debido a mantenimiento o causas técnicas.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <ul className="list-disc list-inside space-y-1 text-muted-foreground">
                ...
                <li>
                  No utilizar el sitio para actividades fraudulentas o ilegales
                </li>
                <li>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground leading-relaxed">
                ...
                Particulares. Para información detallada, consulta nuestra{" "}
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  ...
                  Cancelación y Oposición contactándonos en{" "}
                  <a
                    href="mailto:privacy@mort.dev"
                    className="text-primary hover:underline"
                  >
                    privacy@mort.dev
                  </a>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground leading-relaxed">
                Este aviso legal se rige por la legislación mexicana,
                específicamente:
              </p>
              <ul className="list-disc list-inside space-y-1 text-muted-foreground">
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground leading-relaxed">
                ...
                inmediatamente después de su publicación en este sitio web. Se
                recomienda revisar periódicamente esta página para mantenerse
