                    ...
                    <div className="relative w-full max-w-md mx-auto lg:max-w-none terminal-container">
                        <div className="bg-card border rounded-2xl p-4 sm:p-6 shadow-2xl relative z-10">
                            <div className="flex items-center space-x-2 mb-4">
                                ...
                                <div className="text-xs sm:text-sm text-muted-foreground">~/mort/projects</div>
                            </div>
                            ...
                            <div className="space-y-2 sm:space-y-3 font-mono text-xs sm:text-sm">
                                ...
                                <div className="text-green-400 mt-3 sm:mt-4">$ cat profile.json</div>
                                <div className="pl-2 text-gray-600">{'{'}</div>
                                <div className="pl-3 sm:pl-4">
                                    <span className="text-orange-400">&quot;name&quot;</span>:{" "}
                                    <span className="text-yellow-400">&quot;Miguel Uicab&quot;</span>,
                                </div>
                                <div className="pl-3 sm:pl-4">
                                ...
                                <div className="pl-3 sm:pl-4">
                                    ...
                                    <span className="text-green-400">[&quot;Laravel&quot;, &quot;PHP&quot;]</span>,
                                </div>
                                <div className="pl-3 sm:pl-4">
