          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground leading-relaxed">
                En <strong>Mort.dev</strong> (Miguel Uicab), nos comprometemos a
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 text-muted-foreground">
                  ...
                  <li>
                    <strong>Analíticas:</strong> Para entender cómo interactúas
                    con nuestro sitio
                  </li>
                  <li>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground mb-4">
                ...
                en Posesión de los Particulares, tienes derecho a:
              </p>
              <ul className="list-disc list-inside space-y-1 text-muted-foreground">
                <li>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground leading-relaxed">
                ...
                ejercer tus derechos, puedes contactarnos:
              </p>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground leading-relaxed">
                ...
                efectivas inmediatamente después de su publicación en este sitio
                web. Te recomendamos revisar periódicamente esta página para
